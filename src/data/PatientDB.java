...
public class PatientDB {
    ...
    public boolean add(Patient p){
        String insert="insert into Patient(patientID, firstName, lastName, gender,dob,tel) values(?,?,?,?,?,?)";
        try{
    ...
    public ArrayList<Patient> getAll(){
        ...
        try{
            ...
            while(rs.next()){
               ...
               Patient p=new Patient(patID, firstName, lastName, gender, dob, tel);
               pList.add(p);
            }
            return pList;
        }catch(SQLException e){
    ...
    public Patient get(int patientID){
       ...
       try{
           ...
           if(rs.next()){
               ...
               Date dob=rs.getDate("dob");
               String tel=rs.getString("tel");
               p=new Patient(patID, firstName, lastName, gender, dob, tel);
           }
           rs.close();
           ps.close();
           return p;
    ...
    public boolean update(Patient p){
        String update="update Patient set firstName=?, lastName=?, gender=?, dob=?, tel=? where patientID=?";
        try{
